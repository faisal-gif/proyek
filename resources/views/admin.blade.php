...
<head>
    ...
    <!-- DEMO CHARTS -->
    <link rel="stylesheet" type="text/css" href="{{ asset('style/public/demo/chartist.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('style/public/demo/chartist-plugin-tooltip.css') }}">


    <!-- Template -->
    <link rel="stylesheet" type="text/css" href="{{ asset('style/public/graindashboard/css/graindashboard.css') }}">
        ...
        <div class="py-4 px-3 px-md-4">
            ...
            <div class="row">
                <div class="col-md-6 col-xl-4 mb-3 mb-md-4">
                    ...
                    <div class="card h-100">
                        <div class="card-header d-flex">
                            <h5 class="h6 font-weight-semi-bold text-uppercase mb-0">User</h5>
                        </div>
                        <div class="card-body p-0">
                            <div class="media align-items-center px-3 px-md-4 mb-3 mb-md-4">
                                <div class="media-body">
                                    <h4 class="h3 lh-1 mb-2">250</h4>
                                    <p class="small text-muted mb-0">
                                        +200 <span class="text-success mx-1">+50</span> Users This Month
                                    </p>
                                </div>
                            </div>
                ...
                <div class="col-md-6 col-xl-4 mb-3 mb-md-4">
                    ...
                    <div class="card h-100">
                        <div class="card-header d-flex">
                            <h5 class="h6 font-weight-semi-bold text-uppercase mb-0">Visitors</h5>
                        </div>
                        <div class="card-body p-0">
                            <div class="media align-items-center px-3 px-md-4 mb-3 mb-md-4">
                                <div class="media-body">
                                    <h4 class="h3 lh-1 mb-2">1,240</h4>
                                    <p class="small text-muted mb-0">
                                        +1,200 <span class="text-success mx-1">+40</span> Visitors This Month
                                    </p>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-6 col-xl-4 mb-3 mb-md-4">
                    ...
                    <div class="card h-100">
                        <div class="card-header d-flex">
                            <h5 class="h6 font-weight-semi-bold text-uppercase mb-0">Not me</h5>
                        </div>
                        <div class="card-body p-0">
